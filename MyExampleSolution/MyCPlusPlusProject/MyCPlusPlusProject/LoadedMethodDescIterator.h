...
class LoadedMethodDescIterator
{
	...
	typedef void (LoadedMethodDescIterator::*PFN_LoadedMethodDescIteratorConstructor_v47)(AppDomain * pAppDomain, Module *pModule, mdMethodDef md, AssemblyIterationMode mode, AssemblyIterationFlags a, ModuleIterationOption b);
...
public:
	LoadedMethodDescIterator(AppDomain * pAppDomain, Module *pModule, mdMethodDef md)
	{
		...
		if (s_pfnConstructor_v47)
			(this->*s_pfnConstructor_v47)(pAppDomain, pModule, md, kModeAllADAssemblies, (AssemblyIterationFlags)(kIncludeLoaded | kIncludeExecution), kModIterIncludeLoaded);
	}
...
private:
	...
	// constructor for .Net4.7
	static PFN_LoadedMethodDescIteratorConstructor_v47 s_pfnConstructor_v47;
...
public:
	static void MatchAddress(PSYMBOL_INFOW pSymbolInfo)
	{
		...
		if (wcscmp(L"LoadedMethodDescIterator::LoadedMethodDescIterator", pSymbolInfo->Name) == 0)
		{
			...
			case DotNetVersion_46:
				...
				break;
			case DotNetVersion_47:
				pDest = (LPVOID*)&(LoadedMethodDescIterator::s_pfnConstructor_v47);
				break;
	...
	{
		return (s_pfnConstructor || s_pfnConstructor_v45 || s_pfnConstructor_v46 || s_pfnConstructor_v47) &&
